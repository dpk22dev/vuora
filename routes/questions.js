...
router.get(['/find', '/unauth/find'], function (req, res) {
...
router.get(['/questionbytag', '/unauth/questionbytag'], function (req, res) {
...
router.post(['/votecount', '/unauth/votecount'], jsonParser, function (req, res) {
    var data = req.body;
