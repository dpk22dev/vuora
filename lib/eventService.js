...
meeting.createSeminar = function (data, callback) {
    ...
    var seminar = new Event(data.title, meetingType.SEM, null, from, to,
...
meeting.isConflict = function (data, callback) {
    ...
    var query = {
        $or: [
            {$and: [{from: {$gt: testFrom}}, {to: {$gt: testTo}}, {requestee: uid}]},
            {$and: [{from: {$lt: testFrom}}, {to: {$lt: testTo}}, {requestee: uid}]},
            {$and: [{from: {$lt: testFrom}}, {to: {$gt: testTo}}, {requestee: uid}]},
            {$and: [{from: testFrom}, {to: testTo}, {requestee: uid}]}
        ]
    };
    console.log(JSON.stringify(query));
