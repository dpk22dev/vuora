                    ...
                    updateToElastic(id, QUESTION_VOTE, function (err, res) {
                        if (err) {
                            questionCollection.deleteOne({
                                ...
                                callback(util.convertToResponse(err, {data: 'Successfully ' + data.vote}, 'Error occured while connecting to ES... rolling back'))
                            })
                        } else {
                            callback(util.convertToResponse(err, {data: 'Successfully ' + data.vote}, 'Error occured while connecting to ES'))
                        }
                    })
                } else {
                    callback(util.convertToResponse(err, {data: 'Successfully ' + data.vote}, 'Error occured while connecting to mongo'))
                }
